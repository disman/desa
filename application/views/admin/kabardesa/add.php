<div id="content">
    ...
    <div class="content-inner">
        <div class="form-wrapper">
            <?php echo form_open_multipart('admin/kabardesa/tambah', array('method' => 'POST')); ?>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control summernote" placeholder="Kabar desa..." name="content"></textarea>
